          ...
          >
            <div className="w-full max-w-5xl flex flex-col items-center gap-8">
              ...
              <div className="text-center space-y-4">
                <div className="flex flex-row gap-5 items-center justify-center">
                  ...
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[#fff] text-xs font-semibold mb-4"
                  >
                    <Users size={14} /> 20 Listeners Online
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[#fff] text-xs font-semibold mb-4"
                  >
                    <Zap size={14} />Connection in under 20 seconds
                  </motion.div>
                </div>
              ...
              <div className="flex flex-col items-center gap-6 w-full">
                ...
                >
                  Want to earn by listening?{' '}
                  <span className="underline decoration-[#DEB99D]/50 underline-offset-4 font-semibold text-[#DEB99D]">
                    Become a Listener
                  </span>
                </Link>
              </div>
            ...
            <div className="w-full max-w-5xl space-y-8 bg-black/40 backdrop-blur-xl p-6 md:p-12 rounded-[2.5rem] border border-white/10 shadow-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 bg-gradient-to-br from-purple-900/40 to-black/40 p-6 rounded-3xl border border-purple-500/30">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-white/80">
                    <p className="flex items-center gap-2">
                      <CircleCheck size={16} className="text-green-400" /> First 3 calls under 2 min
                      don't count
                    </p>
                    <p className="flex items-center gap-2">
                      <CircleCheck size={16} className="text-green-400" /> Control everything from
                      your dashboard
                    </p>
                  </div>
                </div>
                ...
                <div className="md:col-span-2 space-y-4">
                  <h3 className="text-center font-bold text-white uppercase tracking-widest text-sm">
                    Call Process
                  </h3>
              ...
              <div className="flex flex-col items-center gap-4 pt-6">
                ...
                >
                  ...
                  <div className="text-[10px] opacity-70 font-normal uppercase tracking-widest mt-1">
                    Connected in ~15 seconds
                  </div>
                </button>

                <div className="flex flex-wrap justify-center gap-6 text-[11px] text-white/40 uppercase tracking-tighter">
                  <span className="flex items-center gap-1">
                    <Heart size={12} /> 100% Private
                  </span>
                  <span className="flex items-center gap-1">
                    <DoorOpen size={12} /> Hang up anytime
                  </span>
                  <span className="flex items-center gap-1">
                    <Activity size={12} /> Real Humans
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1.5">
            {items.map((item, i) => (
              <li
                key={i}
                className={`text-sm flex items-center gap-2 ${item.highlight ? 'text-[#F8CD8B] font-semibold' : 'text-white/60'}`}
              >
                <div
                  className={`w-1 h-1 rounded-full ${item.highlight ? 'bg-[#F8CD8B]' : 'bg-white/30'}`}
                />
                {item.text}
              </li>
            ))}
...
function TimelineStep({
  ...
  return (
    <div className="flex flex-col items-center text-center p-4 bg-white/5 rounded-2xl border border-white/5">
      <div className={`p-3 rounded-full mb-3 ${color} text-white`}>{icon}</div>
