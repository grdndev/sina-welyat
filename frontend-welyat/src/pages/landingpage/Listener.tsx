    ...
    <Layout>
      <div className="text-xl p-5 z-10">
        <div className="flex flex-col items-center justify-center gap-3 p-10">
          ...
          <Link
            to="/register"
            className="rounded-full bg-linear-to-r from-button-from to-button-to py-2 px-8 text-white"
          >
            Apply to Listen
          </Link>
          <div className="text-text-secondary">
            No resume needed. Simple sign-up. Voice test required.
          </div>
        </div>
        <div className="grid grid-cols-5 gap-5">
          <div className="col-span-3">
            <h1 className="text-4xl font-semibold tracking-wide">
              Fair Earnings, Transparent & Easy
            </h1>
            <div className="flex flex-col gap-4 py-5">
              <div className="flex gap-4 bg-background/80 p-6 rounded-lg">
                <Clock10
                  size={60}
                  className="text-accent-soft rounded-full bg-white/50 border-3 border-gray-300/50 p-2"
                />
        ...
        <div className="grid grid-cols-3 bg-linear-to-b from-background to-transparent rounded-lg p-6">
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-2 max-w-2/3">
              ...
              <div>You remain anonymous, no personal info shared with callers.</div>
            </div>
          </div>
          <div className="flex gap-4">
            <Star
            ...
            <div className="flex flex-col gap-2 max-w-2/3">
              ...
              <div>
                Build a reputation of excellent listening. Your empthy is rated anonymously by
                users.
              </div>
            </div>
          </div>
