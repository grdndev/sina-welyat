...
export default function Register() {
  ...
  <div className="w-full flex items-center justify-center -m-2 sm:-m-4 md:-m-4" style={{ minHeight: 'calc(100vh - 200px)' }}>
    <div className="flex w-full max-w-4xl  bg-white/30 backdrop-blur-md border border-white/30 shadow-lg shadow-2xl rounded-3xl overflow-hidden min-h-[600px]">
      ...
      <div className="flex flex-col justify-center  w-full md:w-1/2 px-10 py-12">
        ...
        <h1 className="text-center text-text-primary text-3xl font-extrabold tracking-tight my-4">Create  <span style={{ color: '#8e5cff' }} > Account </span></h1>
        ...
        <form className="flex flex-col gap-3" onSubmit={handleFormSubmit}>
          ...
          {/* Confirm Password */}
          <div className="flex flex-col gap-1">
            <label htmlFor="confirm" className="text-xs font-bold text-text-primary uppercase tracking-wider">Confirm Password</label>
            <div className="relative flex items-center">
              <input
                id="confirm"
          ...
          <div className="flex items-start gap-2 mt-1">
            ...
            <label htmlFor="terms" className="text-xs text-gray-500">
              I agree to the{' '}
              <a href="#" className="text-text-primary underline hover:text-text-primary transition">Terms of Service</a>
              {' '}and{' '}
              <a href="#" className="text-text-primary underline hover:text-text-primary transition">Privacy Policy</a>
            </label>
          </div>
 
          {/* Submit */}
          <Button typeBtn="submit" name={loading ? 'Creating Account...' : 'Create Account'} className="w-full mt-4 px-6 py-3 bg-blue-700 text-white rounded-xl font-semibold hover:bg-blue-800 transition"  />
          {/* Login redirect */}
